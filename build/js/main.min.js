(function () {
  ...
  $(function () {
    ...
    $('.trader-prev').on('click', function (e) {
      e.preventDefault();
      $('[data-trader]').removeClass('active'); // console.log($(this).data('trader'));

      $('[data-trader="' + $(this).data('trader') + '"]').addClass('active');
    });
    $('.h-menu-btn, .menu-list__link').on('click', function () {
      $('.h-menu-btn').toggleClass('active'); // $('.menu__link')

      $('.menu').toggleClass('active'); // $('.social-links').toggleClass('active');
    });
  });
